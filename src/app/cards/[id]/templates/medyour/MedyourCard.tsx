...
// Helper to render the X(Twitter) card with given href and label styles
function TwitterXSocialItem() {
  return (
    <a
    ...
    >
      <div className={s.socialLeft} style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
        ...
        <span
          className={s.socialName}
          style={{ color: "#1e40af", fontWeight: 500, fontSize: "1rem" }}
        >
          X
        </span>
      </div>
        ...
        <div className={s.stack}>
          ...
          <section className={s.contactCard}>
            ...
            <a className={s.contactLine} href={`tel:${phone1}`}>
              <span className={s.contactLabel}>Call Us</span>
              <br /> <span className={s.contactValue}>{phone1}</span>
            </a>
            <a className={s.contactLine} href={`tel:${phone2}`}>
              <span className={s.contactLabel}>Call Us</span>
              <br /> <span className={s.contactValue}>{phone2}</span>
            </a>
            <a className={s.contactLine} href={`mailto:${email}`}>
              <span className={s.contactLabel}>Email</span>
              <br /> <span className={s.contactValue}>{email}</span>
            </a>
          </section>
